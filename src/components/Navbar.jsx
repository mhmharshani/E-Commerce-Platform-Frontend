    ...
    return (
        <Navbar fluid rounded>
            <NavbarBrand href="https://flowbite-react.com">
                <img src="src\assets\logo.png" className="mr-3 h-6 sm:h-9" alt="Green Home Logo" />
                <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Green Home</span>
            </NavbarBrand>
